# Exp 028 — sweep_6per_a_ihl100_seed42
...
Sweep A_ihl100 @ 6%: IHL bump alone
...
```bash
python training/forgetmi_loku.py --config config.yaml --fresh --exp sweep_6per_a_ihl100_seed42
```
