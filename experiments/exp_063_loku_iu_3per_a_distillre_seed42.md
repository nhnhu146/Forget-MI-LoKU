# Exp 063 — loku_iu_3per_a_distillre_seed42
...
```bash
python training/forgetmi_loku.py --config config.yaml --fresh --exp loku_iu_3per_a_distillre_seed42
```
...
```
[E00] loss=+12.841  UKR=+2.879  MKR=+3.166  CLS_ret=+0.700  DSL_ret=+0.8786  DSL_frg=+2.3841  IHL_frg=+1.3554  | CosSim(ul,re)=0.9568
[E01] loss=+7.450  UKR=+0.797  MKR=+1.777  CLS_ret=+0.506  DSL_ret=+0.4767  DSL_frg=+1.4531  IHL_frg=+1.3570  | CosSim(ul,re)=0.9354
[E02] loss=+6.760  UKR=+0.653  MKR=+1.899  CLS_ret=+0.419  DSL_ret=+0.3423  DSL_frg=+1.2259  IHL_frg=+1.3040  | CosSim(ul,re)=0.9303
[E03] loss=+5.288  UKR=+0.635  MKR=+1.556  CLS_ret=+0.339  DSL_ret=+0.1299  DSL_frg=+0.5794  IHL_frg=+1.3159  | CosSim(ul,re)=0.9377
[E04] loss=+4.867  UKR=+0.526  MKR=+1.497  CLS_ret=+0.361  DSL_ret=+0.1175  DSL_frg=+0.4268  IHL_frg=+1.2153  | CosSim(ul,re)=0.9308
```
<!-- /AUTO -->
...
|---|---|---|
| MIA_persample ↓ | **0.613** | (LoKU per-sample SVM) |
| MIA_paper ↓ | **0.167** | -0.404 ✅ |
| Forget AUC ↓ | **0.826** | +0.091 ❌ |
| Forget F1 ↓ | **0.673** | +0.280 ❌ |
