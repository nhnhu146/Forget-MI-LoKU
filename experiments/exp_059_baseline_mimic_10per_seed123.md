# Exp 059 — baseline_mimic_10per_seed123

| Field | Value |
|---|---|
| **Date** | 2026-06-27 |
| **Git commit** | `9f88211 (dirty)` |
| **Branch** | `master` |
...
Baseline Forget-MI tại MIMIC-CXR 10%, Kaggle reproduce.
...
```bash
python training/forgetmi_loku.py --config config.yaml --fresh --exp baseline_mimic_10per_seed123
```
...
| MIA_paper ↓ | **0.909** | +0.338 ❌ |
| Forget AUC ↓ | **0.764** | +0.029 ❌ |
| Forget F1 ↓ | **0.385** | -0.008 ✅ |
| Test AUC ↑ | **0.654** | +0.029 ✅ |
| Test F1 ↑ | **0.385** | +0.135 ✅ |
| 1−CosSim ↓ | **0.414** | -0.036 ✅ |
| Time (h) | **3.850** | -1.150 ✅ |
| GPU peak (GB) | **8.49** | — |
