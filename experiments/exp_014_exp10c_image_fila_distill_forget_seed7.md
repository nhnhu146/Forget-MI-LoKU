# Exp 014 — exp10c_image_fila_distill_forget_seed7
...
```bash
python training/forgetmi_loku.py --config config.yaml --fresh --exp exp10c_image_fila_distill_forget_seed7
```
...
```
[E00] loss=+15.708  UKR=+0.810  MKR=+2.584  CLS_ret=+1.485  DSL_ret=+3.5890  DSL_frg=+3.9605  IHL_frg=+0.0000  | CosSim(ul,re)=0.6808
[E01] loss=+13.585  UKR=+0.420  MKR=+1.836  CLS_ret=+1.263  DSL_ret=+3.3731  DSL_frg=+3.7428  IHL_frg=+0.0000  | CosSim(ul,re)=0.6798
[E02] loss=+12.053  UKR=+0.339  MKR=+1.646  CLS_ret=+1.099  DSL_ret=+2.9950  DSL_frg=+3.3777  IHL_frg=+0.0000  | CosSim(ul,re)=0.6997
[E03] loss=+11.472  UKR=+0.344  MKR=+1.565  CLS_ret=+0.984  DSL_ret=+2.8857  DSL_frg=+3.2678  IHL_frg=+0.0000  | CosSim(ul,re)=0.7111
[E04] loss=+10.975  UKR=+0.323  MKR=+1.493  CLS_ret=+0.904  DSL_ret=+2.7865  DSL_frg=+3.1706  IHL_frg=+0.0000  | CosSim(ul,re)=0.7150
[E05] loss=+10.626  UKR=+0.364  MKR=+1.448  CLS_ret=+0.837  DSL_ret=+2.7290  DSL_frg=+3.0473  IHL_frg=+0.0000  | CosSim(ul,re)=0.7100
[E06] loss=+10.308  UKR=+0.326  MKR=+1.402  CLS_ret=+0.801  DSL_ret=+2.6924  DSL_frg=+2.9393  IHL_frg=+0.0000  | CosSim(ul,re)=0.7083
[E07] loss=+10.071  UKR=+0.335  MKR=+1.369  CLS_ret=+0.778  DSL_ret=+2.6389  DSL_frg=+2.8527  IHL_frg=+0.0000  | CosSim(ul,re)=0.6990
```
<!-- /AUTO -->
...
|---|---|---|
| MIA_persample ↓ | **0.403** | (LoKU per-sample SVM) |
| MIA_paper ↓ | **0.429** | -0.142 ✅ |
| Forget AUC ↓ | **0.686** | -0.049 ✅ |
| Forget F1 ↓ | **0.273** | -0.120 ✅ |
| Test AUC ↑ | **0.675** | +0.050 ✅ |
| Test F1 ↑ | **0.348** | +0.098 ✅ |
| 1−CosSim ↓ | **0.321** | -0.129 ✅ |
| Time (h) | **0.185** | -4.815 ✅ |
| GPU peak (GB) | **11.78** | — |
