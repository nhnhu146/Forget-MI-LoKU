# Exp 036 — sweep_10per_b_img050_seed42
...
Sweep B_img050 @ 10%: Image-FILA bump alone
...
```bash
python training/forgetmi_loku.py --config config.yaml --fresh --exp sweep_10per_b_img050_seed42
```
