# Exp 052 — sweep_3per_e_extreme_seed42
...
Sweep E_extreme @ 3%: Most aggressive — risk over-forget
...
```bash
python training/forgetmi_loku.py --config config.yaml --fresh --exp sweep_3per_e_extreme_seed42
```
