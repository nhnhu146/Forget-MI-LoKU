# Exp 040 — sweep_10per_f_more_epochs_seed42
...
Sweep F_more_epochs @ 10%: Baseline + epochs 8→12
...
```bash
python training/forgetmi_loku.py --config config.yaml --fresh --exp sweep_10per_f_more_epochs_seed42
```
