# Exp 058 — baseline_mimic_10per_seed42
...
```bash
python training/forgetmi_loku.py --config config.yaml --fresh --exp baseline_mimic_10per_seed42
```
