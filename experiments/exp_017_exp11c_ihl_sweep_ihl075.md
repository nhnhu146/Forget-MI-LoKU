# Exp 017 — exp11c_ihl_sweep_ihl075
...
```bash
python training/forgetmi_loku.py --config config.yaml --fresh --exp exp11c_ihl_sweep_ihl075
```
...
```
[E00] loss=+8.258  UKR=+1.262  MKR=+2.507  CLS_ret=+1.419  DSL_ret=+0.5865  DSL_frg=+0.0000  IHL_frg=+1.0271  | CosSim(ul,re)=0.6654
[E01] loss=+6.917  UKR=+0.420  MKR=+2.149  CLS_ret=+1.319  DSL_ret=+0.6222  DSL_frg=+0.0000  IHL_frg=+1.0362  | CosSim(ul,re)=0.6039
[E02] loss=+5.620  UKR=+0.361  MKR=+1.865  CLS_ret=+1.076  DSL_ret=+0.3147  DSL_frg=+0.0000  IHL_frg=+1.0258  | CosSim(ul,re)=0.6541
[E03] loss=+5.182  UKR=+0.331  MKR=+1.771  CLS_ret=+0.964  DSL_ret=+0.2659  DSL_frg=+0.0000  IHL_frg=+1.0031  | CosSim(ul,re)=0.6811
[E04] loss=+4.961  UKR=+0.342  MKR=+1.718  CLS_ret=+0.896  DSL_ret=+0.2502  DSL_frg=+0.0000  IHL_frg=+0.9779  | CosSim(ul,re)=0.6738
[E05] loss=+4.875  UKR=+0.360  MKR=+1.686  CLS_ret=+0.850  DSL_ret=+0.2736  DSL_frg=+0.0000  IHL_frg=+0.9576  | CosSim(ul,re)=0.6561
[E06] loss=+4.684  UKR=+0.306  MKR=+1.624  CLS_ret=+0.883  DSL_ret=+0.2009  DSL_frg=+0.0000  IHL_frg=+0.9154  | CosSim(ul,re)=0.6470
[E07] loss=+4.602  UKR=+0.299  MKR=+1.585  CLS_ret=+0.862  DSL_ret=+0.2201  DSL_frg=+0.0000  IHL_frg=+0.8848  | CosSim(ul,re)=0.6670
```
<!-- /AUTO -->
