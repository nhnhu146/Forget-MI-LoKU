# Exp 060 — baseline_iu_3per_seed42
...
Baseline Forget-MI tại Indiana University CXR 3%, Kaggle reproduce.
...
```bash
python training/forgetmi_loku.py --config config.yaml --fresh --exp baseline_iu_3per_seed42
```
...
|---|---|---|
| MIA_persample ↓ | **0.565** | (LoKU per-sample SVM) |
| MIA_paper ↓ | **0.000** | -0.571 ✅ |
| Forget AUC ↓ | **0.653** | -0.082 ✅ |
| Forget F1 ↓ | **0.573** | +0.180 ❌ |
| Test AUC ↑ | **0.636** | +0.011 ✅ |
| Test F1 ↑ | **0.573** | +0.323 ✅ |
| 1−CosSim ↓ | **0.098** | -0.352 ✅ |
| Time (h) | **9.518** | +4.518 ❌ |
| GPU peak (GB) | **8.49** | — |
