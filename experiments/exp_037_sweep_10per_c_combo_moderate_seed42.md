# Exp 037 — sweep_10per_c_combo_moderate_seed42

| Field | Value |
|---|---|
| **Date** | 2026-06-25 |
| **Git commit** | `650cebf (dirty)` |
| **Branch** | `master` |
| **Status** | 🔄 Running |
...
Sweep C_combo_moderate @ 10%: Combined moderate (sweet candidate)
...
```bash
python training/forgetmi_loku.py --config config.yaml --fresh --exp sweep_10per_c_combo_moderate_seed42
```
