# Exp 057 — sweep_3per_j_max_push_seed42
...
Sweep J_max_push @ 3%: Maximum aggression — last resort
...
```bash
python training/forgetmi_loku.py --config config.yaml --fresh --exp sweep_3per_j_max_push_seed42
```
