# Exp 049 — sweep_3per_b_img050_seed42
...
Sweep B_img050 @ 3%: Image-FILA bump alone
...
```bash
python training/forgetmi_loku.py --config config.yaml --fresh --exp sweep_3per_b_img050_seed42
```
