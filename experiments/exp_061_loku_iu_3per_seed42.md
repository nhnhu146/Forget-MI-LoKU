...
```bash
python training/forgetmi_loku.py --config config.yaml --fresh --exp loku_iu_3per_seed42
```
...
```
[E00] loss=+8.104  UKR=+1.925  MKR=+2.474  CLS_ret=+0.580  DSL_ret=+0.5231  DSL_frg=+0.0000  IHL_frg=+1.4081  | CosSim(ul,re)=0.9786
[E01] loss=+5.370  UKR=+0.676  MKR=+1.601  CLS_ret=+0.456  DSL_ret=+0.2625  DSL_frg=+0.0000  IHL_frg=+1.4291  | CosSim(ul,re)=0.9572
[E02] loss=+5.157  UKR=+0.523  MKR=+1.539  CLS_ret=+0.433  DSL_ret=+0.2752  DSL_frg=+0.0000  IHL_frg=+1.4527  | CosSim(ul,re)=0.9728
[E03] loss=+4.573  UKR=+0.486  MKR=+1.459  CLS_ret=+0.351  DSL_ret=+0.0916  DSL_frg=+0.0000  IHL_frg=+1.4306  | CosSim(ul,re)=0.9574
[E04] loss=+4.891  UKR=+0.802  MKR=+1.467  CLS_ret=+0.387  DSL_ret=+0.1079  DSL_frg=+0.0000  IHL_frg=+1.3489  | CosSim(ul,re)=0.9542
```
<!-- /AUTO -->
...
|---|---|---|
| MIA_persample ↓ | **0.848** | (LoKU per-sample SVM) |
| MIA_paper ↓ | **0.833** | +0.262 ❌ |
| Forget AUC ↓ | **0.951** | +0.216 ❌ |
| Forget F1 ↓ | **0.874** | +0.481 ❌ |
| Test AUC ↑ | **0.667** | +0.042 ✅ |
| Test F1 ↑ | **0.628** | +0.378 ✅ |
| 1−CosSim ↓ | **0.044** | -0.406 ✅ |
| Time (h) | **0.068** | -4.932 ✅ |
| GPU peak (GB) | **11.78** | — |
