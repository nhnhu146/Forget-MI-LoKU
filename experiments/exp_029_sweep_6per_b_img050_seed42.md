# Exp 029 — sweep_6per_b_img050_seed42
...
Sweep B_img050 @ 6%: Image-FILA bump alone
...
```bash
python training/forgetmi_loku.py --config config.yaml --fresh --exp sweep_6per_b_img050_seed42
```
