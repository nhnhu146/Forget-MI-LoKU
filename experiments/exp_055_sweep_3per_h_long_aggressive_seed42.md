# Exp 055 — sweep_3per_h_long_aggressive_seed42

| Field | Value |
|---|---|
| **Date** | 2026-06-26 |
| **Git commit** | `2a522f6 (dirty)` |
| **Branch** | `master` |
| **Status** | 🔄 Running |
...
Sweep H_long_aggressive @ 3%: D + more epochs (D may not converge in 8)
...
```bash
python training/forgetmi_loku.py --config config.yaml --fresh --exp sweep_3per_h_long_aggressive_seed42
```
