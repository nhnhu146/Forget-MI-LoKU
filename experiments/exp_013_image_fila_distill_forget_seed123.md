# Exp 013 — exp10c_image_fila_distill_forget_seed123
...
```bash
python training/forgetmi_loku.py --config config.yaml --fresh --exp exp10c_image_fila_distill_forget_seed123
```
...
```
[E00] loss=+14.617  UKR=+0.435  MKR=+2.175  CLS_ret=+1.376  DSL_ret=+3.5269  DSL_frg=+3.9644  IHL_frg=+0.0000  | CosSim(ul,re)=0.6727
[E01] loss=+13.020  UKR=+0.315  MKR=+1.701  CLS_ret=+1.164  DSL_ret=+3.2921  DSL_frg=+3.7388  IHL_frg=+0.0000  | CosSim(ul,re)=0.6725
[E02] loss=+12.725  UKR=+0.354  MKR=+1.556  CLS_ret=+1.133  DSL_ret=+3.2235  DSL_frg=+3.7133  IHL_frg=+0.0000  | CosSim(ul,re)=0.6748
[E03] loss=+12.162  UKR=+0.325  MKR=+1.477  CLS_ret=+1.117  DSL_ret=+3.1028  DSL_frg=+3.4718  IHL_frg=+0.0000  | CosSim(ul,re)=0.6867
[E04] loss=+11.669  UKR=+0.335  MKR=+1.435  CLS_ret=+1.069  DSL_ret=+2.9553  DSL_frg=+3.3279  IHL_frg=+0.0000  | CosSim(ul,re)=0.6917
[E05] loss=+11.146  UKR=+0.333  MKR=+1.392  CLS_ret=+0.960  DSL_ret=+2.8482  DSL_frg=+3.2297  IHL_frg=+0.0000  | CosSim(ul,re)=0.7218
[E06] loss=+10.763  UKR=+0.320  MKR=+1.369  CLS_ret=+0.867  DSL_ret=+2.7982  DSL_frg=+3.1414  IHL_frg=+0.0000  | CosSim(ul,re)=0.7258
[E07] loss=+10.428  UKR=+0.324  MKR=+1.335  CLS_ret=+0.834  DSL_ret=+2.7079  DSL_frg=+3.0382  IHL_frg=+0.0000  | CosSim(ul,re)=0.7131
```
<!-- /AUTO -->
...
|---|---|---|
| MIA_persample ↓ | **0.473** | (LoKU per-sample SVM) |
| MIA_paper ↓ | **0.429** | -0.142 ✅ |
| Forget AUC ↓ | **0.700** | -0.035 ✅ |
| Forget F1 ↓ | **0.307** | -0.086 ✅ |
| Test AUC ↑ | **0.673** | +0.048 ✅ |
| Test F1 ↑ | **0.317** | +0.067 ✅ |
| 1−CosSim ↓ | **0.294** | -0.156 ✅ |
| Time (h) | **0.184** | -4.816 ✅ |
| GPU peak (GB) | **11.78** | — |
