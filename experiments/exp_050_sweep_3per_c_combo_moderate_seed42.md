# Exp 050 — sweep_3per_c_combo_moderate_seed42
...
Sweep C_combo_moderate @ 3%: Combined moderate (sweet candidate)
...
```bash
python training/forgetmi_loku.py --config config.yaml --fresh --exp sweep_3per_c_combo_moderate_seed42
```
