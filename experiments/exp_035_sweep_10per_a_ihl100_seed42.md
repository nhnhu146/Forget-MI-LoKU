# Exp 035 — sweep_10per_a_ihl100_seed42
...
Sweep A_ihl100 @ 10%: IHL bump alone
...
```bash
python training/forgetmi_loku.py --config config.yaml --fresh --exp sweep_10per_a_ihl100_seed42
```
