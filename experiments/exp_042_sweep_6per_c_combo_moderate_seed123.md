# Exp 042 — sweep_6per_c_combo_moderate_seed123
...
Sweep C_combo_moderate @ 6%: Combined moderate (sweet candidate)
...
```bash
python training/forgetmi_loku.py --config config.yaml --fresh --exp sweep_6per_c_combo_moderate_seed123
```
