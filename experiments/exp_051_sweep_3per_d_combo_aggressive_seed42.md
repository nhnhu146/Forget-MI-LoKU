# Exp 051 — sweep_3per_d_combo_aggressive_seed42
...
Sweep D_combo_aggressive @ 3%: IHL aggressive + img bump
...
```bash
python training/forgetmi_loku.py --config config.yaml --fresh --exp sweep_3per_d_combo_aggressive_seed42
```
