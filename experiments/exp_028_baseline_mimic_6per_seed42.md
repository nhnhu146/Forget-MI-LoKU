# Exp 028 — baseline_mimic_6per_seed42
...
```bash
python training/forgetmi_loku.py --config config.yaml --fresh --exp baseline_mimic_6per_seed42
```
...
|---|---|---|
| MIA_persample ↓ | **0.431** | (LoKU per-sample SVM) |
| MIA_paper ↓ | **0.769** | +0.198 ❌ |
| Forget AUC ↓ | **0.661** | -0.074 ✅ |
| Forget F1 ↓ | **0.368** | -0.025 ✅ |
| Test AUC ↑ | **0.650** | +0.025 ✅ |
| Test F1 ↑ | **0.368** | +0.118 ✅ |
| 1−CosSim ↓ | **0.431** | -0.019 ✅ |
| Time (h) | **3.291** | -1.709 ✅ |
| GPU peak (GB) | **8.49** | — |
