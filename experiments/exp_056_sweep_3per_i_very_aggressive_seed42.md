# Exp 056 — sweep_3per_i_very_aggressive_seed42
...
Sweep I_very_aggressive @ 3%: Higher IHL + img + lower retain anchor
...
```bash
python training/forgetmi_loku.py --config config.yaml --fresh --exp sweep_3per_i_very_aggressive_seed42
```
