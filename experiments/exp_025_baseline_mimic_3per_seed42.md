# Exp 025 — baseline_mimic_3per_seed42
...
Baseline Forget-MI tại MIMIC-CXR 3%, Kaggle reproduce.
...
```bash
python training/forgetmi_loku.py --config config.yaml --fresh --exp baseline_mimic_3per_seed42
```
