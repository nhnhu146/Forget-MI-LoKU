# Exp 048 — sweep_3per_a_ihl100_seed42
...
Sweep A_ihl100 @ 3%: IHL bump alone
...
```bash
python training/forgetmi_loku.py --config config.yaml --fresh --exp sweep_3per_a_ihl100_seed42
```
