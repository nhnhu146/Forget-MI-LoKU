# Exp 032 — sweep_6per_e_extreme_seed42
...
Sweep E_extreme @ 6%: Most aggressive — risk over-forget
...
```bash
python training/forgetmi_loku.py --config config.yaml --fresh --exp sweep_6per_e_extreme_seed42
```
