# Exp 039 — sweep_10per_e_extreme_seed42
...
Sweep E_extreme @ 10%: Most aggressive — risk over-forget
...
```bash
python training/forgetmi_loku.py --config config.yaml --fresh --exp sweep_10per_e_extreme_seed42
```
