# Exp 041 — sweep_10per_g_less_retain_seed42
...
Sweep G_less_retain @ 10%: Baseline + kappa_cls_retain 2→1
...
```bash
python training/forgetmi_loku.py --config config.yaml --fresh --exp sweep_10per_g_less_retain_seed42
```
