# Exp 065 — loku_iu_3per_c_ihl_high_seed42
...
```bash
python training/forgetmi_loku.py --config config.yaml --fresh --exp loku_iu_3per_c_ihl_high_seed42
```
...
```
[E00] loss=+9.027  UKR=+1.495  MKR=+1.739  CLS_ret=+0.465  DSL_ret=+0.2836  DSL_frg=+0.0000  IHL_frg=+1.4786  | (fixed epochs)
[E01] loss=+7.718  UKR=+0.490  MKR=+1.533  CLS_ret=+0.476  DSL_ret=+0.2788  DSL_frg=+0.0000  IHL_frg=+1.4418  | (fixed epochs)
[E02] loss=+7.260  UKR=+0.488  MKR=+1.503  CLS_ret=+0.431  DSL_ret=+0.1712  DSL_frg=+0.0000  IHL_frg=+1.3831  | (fixed epochs)
[E03] loss=+6.893  UKR=+0.489  MKR=+1.444  CLS_ret=+0.363  DSL_ret=+0.0810  DSL_frg=+0.0000  IHL_frg=+1.3707  | (fixed epochs)
[E04] loss=+6.681  UKR=+0.481  MKR=+1.408  CLS_ret=+0.376  DSL_ret=+0.0649  DSL_frg=+0.0000  IHL_frg=+1.3142  | (fixed epochs)
[E05] loss=+6.577  UKR=+0.470  MKR=+1.384  CLS_ret=+0.385  DSL_ret=+0.0920  DSL_frg=+0.0000  IHL_frg=+1.2718  | (fixed epochs)
[E06] loss=+6.364  UKR=+0.475  MKR=+1.382  CLS_ret=+0.340  DSL_ret=+0.0677  DSL_frg=+0.0000  IHL_frg=+1.2421  | (fixed epochs)
[E07] loss=+6.330  UKR=+0.471  MKR=+1.364  CLS_ret=+0.374  DSL_ret=+0.0637  DSL_frg=+0.0000  IHL_frg=+1.2168  | (fixed epochs)
[E08] loss=+6.296  UKR=+0.483  MKR=+1.385  CLS_ret=+0.376  DSL_ret=+0.0931  DSL_frg=+0.0000  IHL_frg=+1.1787  | (fixed epochs)
[E09] loss=+6.179  UKR=+0.475  MKR=+1.359  CLS_ret=+0.345  DSL_ret=+0.0835  DSL_frg=+0.0000  IHL_frg=+1.1765  | (fixed epochs)
[E10] loss=+5.945  UKR=+0.471  MKR=+1.325  CLS_ret=+0.356  DSL_ret=+0.0436  DSL_frg=+0.0000  IHL_frg=+1.1236  | (fixed epochs)
[E11] loss=+5.789  UKR=+0.471  MKR=+1.271  CLS_ret=+0.344  DSL_ret=+0.0392  DSL_frg=+0.0000  IHL_frg=+1.1001  | (fixed epochs)
[E12] loss=+5.644  UKR=+0.456  MKR=+1.240  CLS_ret=+0.349  DSL_ret=+0.0352  DSL_frg=+0.0000  IHL_frg=+1.0658  | (fixed epochs)
[E13] loss=+5.530  UKR=+0.460  MKR=+1.201  CLS_ret=+0.334  DSL_ret=+0.0297  DSL_frg=+0.0000  IHL_frg=+1.0519  | (fixed epochs)
[E14] loss=+5.370  UKR=+0.449  MKR=+1.167  CLS_ret=+0.338  DSL_ret=+0.0160  DSL_frg=+0.0000  IHL_frg=+1.0178  | (fixed epochs)
```
<!-- /AUTO -->
...
|---|---|---|
| MIA_persample ↓ | **0.550** | (LoKU per-sample SVM) |
| MIA_paper ↓ | **0.000** | -0.571 ✅ |
| Forget AUC ↓ | **0.714** | -0.021 ✅ |
| Forget F1 ↓ | **0.462** | +0.069 ❌ |
| Test AUC ↑ | **0.620** | -0.005 ❌ |
| Test F1 ↑ | **0.554** | +0.304 ✅ |
| 1−CosSim ↓ | **0.078** | -0.372 ✅ |
| Time (h) | **0.128** | -4.872 ✅ |
| GPU peak (GB) | **11.78** | — |
