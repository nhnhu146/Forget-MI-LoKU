# Exp 023 — exp11_final_ihl075_seed123
...
```bash
python training/forgetmi_loku.py --config config.yaml --fresh --exp exp11_final_ihl075_seed123
```
...
```
[E00] loss=+7.401  UKR=+0.553  MKR=+2.568  CLS_ret=+1.364  DSL_ret=+0.5144  DSL_frg=+0.0000  IHL_frg=+1.0389  | val_CE=1.3663
[E01] loss=+6.205  UKR=+0.568  MKR=+1.797  CLS_ret=+1.171  DSL_ret=+0.4739  DSL_frg=+0.0000  IHL_frg=+1.0482  | val_CE=0.8913
[E02] loss=+5.334  UKR=+0.411  MKR=+1.606  CLS_ret=+1.025  DSL_ret=+0.3348  DSL_frg=+0.0000  IHL_frg=+1.0195  | val_CE=1.0719
[E03] loss=+5.003  UKR=+0.373  MKR=+1.475  CLS_ret=+0.957  DSL_ret=+0.3184  DSL_frg=+0.0000  IHL_frg=+1.0191  | val_CE=0.8904
[E04] loss=+4.760  UKR=+0.336  MKR=+1.407  CLS_ret=+0.966  DSL_ret=+0.2362  DSL_frg=+0.0000  IHL_frg=+0.9728  | val_CE=0.9015
[E05] loss=+4.694  UKR=+0.350  MKR=+1.390  CLS_ret=+0.811  DSL_ret=+0.4023  DSL_frg=+0.0000  IHL_frg=+0.9724  | val_CE=0.9712
[E06] loss=+4.490  UKR=+0.323  MKR=+1.340  CLS_ret=+0.848  DSL_ret=+0.2834  DSL_frg=+0.0000  IHL_frg=+0.9412  | val_CE=0.8922
[E07] loss=+4.329  UKR=+0.311  MKR=+1.301  CLS_ret=+0.843  DSL_ret=+0.2370  DSL_frg=+0.0000  IHL_frg=+0.9017  | val_CE=0.9180
```
<!-- /AUTO -->
...
|---|---|---|
| MIA_persample ↓ | **0.423** | (LoKU per-sample SVM) |
| MIA_paper ↓ | **0.286** | -0.285 ✅ |
| Forget AUC ↓ | **0.742** | +0.007 ❌ |
| Forget F1 ↓ | **0.395** | +0.002 ❌ |
| Test AUC ↑ | **0.679** | +0.054 ✅ |
| Test F1 ↑ | **0.389** | +0.139 ✅ |
| 1−CosSim ↓ | **0.339** | -0.111 ✅ |
| Time (h) | **0.219** | -4.781 ✅ |
| GPU peak (GB) | **11.78** | — |
