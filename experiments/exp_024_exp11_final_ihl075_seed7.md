# Exp 024 — exp11_final_ihl075_seed7
...
```bash
python training/forgetmi_loku.py --config config.yaml --fresh --exp exp11_final_ihl075_seed7
```
...
```
[E00] loss=+7.539  UKR=+0.620  MKR=+2.601  CLS_ret=+1.352  DSL_ret=+0.5552  DSL_frg=+0.0000  IHL_frg=+1.0417  | val_CE=1.3634
[E01] loss=+6.465  UKR=+0.468  MKR=+1.966  CLS_ret=+1.229  DSL_ret=+0.5287  DSL_frg=+0.0000  IHL_frg=+1.0418  | val_CE=0.9481
[E02] loss=+5.337  UKR=+0.376  MKR=+1.659  CLS_ret=+1.038  DSL_ret=+0.3098  DSL_frg=+0.0000  IHL_frg=+1.0168  | val_CE=0.9784
[E03] loss=+4.874  UKR=+0.316  MKR=+1.543  CLS_ret=+0.930  DSL_ret=+0.2732  DSL_frg=+0.0000  IHL_frg=+0.9924  | val_CE=0.9729
[E04] loss=+4.576  UKR=+0.296  MKR=+1.465  CLS_ret=+0.860  DSL_ret=+0.2530  DSL_frg=+0.0000  IHL_frg=+0.9536  | val_CE=1.0339
[E05] loss=+4.419  UKR=+0.293  MKR=+1.409  CLS_ret=+0.806  DSL_ret=+0.2796  DSL_frg=+0.0000  IHL_frg=+0.9154  | val_CE=1.1104
```
<!-- /AUTO -->
...
| Forget AUC ↓ | **0.733** | -0.002 ✅ |
| Forget F1 ↓ | **0.363** | -0.030 ✅ |
