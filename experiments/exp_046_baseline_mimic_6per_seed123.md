# Exp 046 — baseline_mimic_6per_seed123
...
```bash
python training/forgetmi_loku.py --config config.yaml --fresh --exp baseline_mimic_6per_seed123
```
