# Exp 044 — sweep_10per_d_combo_aggressive_seed123
...
Sweep D_combo_aggressive @ 10%: IHL aggressive + img bump
...
```bash
python training/forgetmi_loku.py --config config.yaml --fresh --exp sweep_10per_d_combo_aggressive_seed123
```
