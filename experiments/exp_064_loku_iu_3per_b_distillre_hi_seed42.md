# Exp 064 — loku_iu_3per_b_distillre_hi_seed42
...
```bash
python training/forgetmi_loku.py --config config.yaml --fresh --exp loku_iu_3per_b_distillre_hi_seed42
```
...
```
[E00] loss=+20.669  UKR=+4.480  MKR=+4.165  CLS_ret=+1.134  DSL_ret=+1.7042  DSL_frg=+2.8091  IHL_frg=+1.2660  | CosSim(ul,re)=0.9605
[E01] loss=+9.639  UKR=+0.914  MKR=+2.282  CLS_ret=+0.381  DSL_ret=+0.2594  DSL_frg=+1.7511  IHL_frg=+1.4313  | CosSim(ul,re)=0.9349
[E02] loss=+6.593  UKR=+0.863  MKR=+1.713  CLS_ret=+0.381  DSL_ret=+0.2525  DSL_frg=+0.6167  IHL_frg=+1.3143  | CosSim(ul,re)=0.9368
[E03] loss=+5.369  UKR=+0.570  MKR=+1.520  CLS_ret=+0.346  DSL_ret=+0.1273  DSL_frg=+0.4237  IHL_frg=+1.2388  | CosSim(ul,re)=0.9439
[E04] loss=+4.627  UKR=+0.520  MKR=+1.485  CLS_ret=+0.335  DSL_ret=+0.0866  DSL_frg=+0.1818  IHL_frg=+1.1658  | CosSim(ul,re)=0.9480
```
<!-- /AUTO -->
...
|---|---|---|
| MIA_persample ↓ | **0.618** | (LoKU per-sample SVM) |
| MIA_paper ↓ | **0.000** | -0.571 ✅ |
| Forget AUC ↓ | **0.795** | +0.060 ❌ |
| Forget F1 ↓ | **0.640** | +0.247 ❌ |
| Test AUC ↑ | **0.689** | +0.064 ✅ |
| Test F1 ↑ | **0.624** | +0.374 ✅ |
| 1−CosSim ↓ | **0.063** | -0.387 ✅ |
| Time (h) | **0.072** | -4.928 ✅ |
| GPU peak (GB) | **11.78** | — |
