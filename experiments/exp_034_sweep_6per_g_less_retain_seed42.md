# Exp 034 — sweep_6per_g_less_retain_seed42
...
Sweep G_less_retain @ 6%: Baseline + kappa_cls_retain 2→1
...
```bash
python training/forgetmi_loku.py --config config.yaml --fresh --exp sweep_6per_g_less_retain_seed42
```
