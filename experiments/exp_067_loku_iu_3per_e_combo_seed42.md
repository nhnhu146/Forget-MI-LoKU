# Exp 067 — loku_iu_3per_e_combo_seed42
...
```bash
python training/forgetmi_loku.py --config config.yaml --fresh --exp loku_iu_3per_e_combo_seed42
```
...
```
[E00] loss=+19.950  UKR=+4.265  MKR=+4.812  CLS_ret=+1.335  DSL_ret=+2.1015  DSL_frg=+3.0280  IHL_frg=+1.1984  | CosSim(ul,re)=0.9466
[E01] loss=+9.774  UKR=+1.451  MKR=+1.886  CLS_ret=+0.513  DSL_ret=+0.5449  DSL_frg=+1.9165  IHL_frg=+1.4202  | CosSim(ul,re)=0.9470
[E02] loss=+6.372  UKR=+0.605  MKR=+1.636  CLS_ret=+0.351  DSL_ret=+0.1616  DSL_frg=+0.7899  IHL_frg=+1.2997  | CosSim(ul,re)=0.9396
[E03] loss=+5.358  UKR=+0.519  MKR=+1.494  CLS_ret=+0.344  DSL_ret=+0.0841  DSL_frg=+0.5549  IHL_frg=+1.1684  | CosSim(ul,re)=0.9421
[E04] loss=+4.952  UKR=+0.508  MKR=+1.457  CLS_ret=+0.333  DSL_ret=+0.0957  DSL_frg=+0.3882  IHL_frg=+1.1313  | CosSim(ul,re)=0.9275
[E05] loss=+4.548  UKR=+0.491  MKR=+1.428  CLS_ret=+0.332  DSL_ret=+0.0497  DSL_frg=+0.2985  IHL_frg=+1.0909  | CosSim(ul,re)=0.9223
```
<!-- /AUTO -->
...
|---|---|---|
| MIA_persample ↓ | **0.497** | (LoKU per-sample SVM) |
| MIA_paper ↓ | **0.000** | -0.571 ✅ |
| Forget AUC ↓ | **0.648** | -0.087 ✅ |
| Forget F1 ↓ | **0.554** | +0.161 ❌ |
