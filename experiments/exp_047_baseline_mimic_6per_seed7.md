# Exp 047 — baseline_mimic_6per_seed7

| Field | Value |
|---|---|
| **Date** | 2026-06-25 |
| **Git commit** | `303d4cf (dirty)` |
| **Branch** | `master` |
...
Baseline Forget-MI tại MIMIC-CXR 6%, Kaggle reproduce.
...
```bash
python training/forgetmi_loku.py --config config.yaml --fresh --exp baseline_mimic_6per_seed7
```
...
|---|---|---|
| MIA_persample ↓ | **0.451** | (LoKU per-sample SVM) |
| MIA_paper ↓ | **0.769** | +0.198 ❌ |
| Forget AUC ↓ | **0.661** | -0.074 ✅ |
| Forget F1 ↓ | **0.377** | -0.016 ✅ |
| Test AUC ↑ | **0.650** | +0.025 ✅ |
| Test F1 ↑ | **0.377** | +0.127 ✅ |
| 1−CosSim ↓ | **0.397** | -0.053 ✅ |
| Time (h) | **3.295** | -1.705 ✅ |
| GPU peak (GB) | **8.49** | — |
