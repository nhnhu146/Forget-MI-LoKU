# Exp 018 — exp11c_ihl_sweep_ihl100
...
```bash
python training/forgetmi_loku.py --config config.yaml --fresh --exp exp11c_ihl_sweep_ihl100
```
...
```
[E00] loss=+7.704  UKR=+0.932  MKR=+2.159  CLS_ret=+1.380  DSL_ret=+0.5433  DSL_frg=+0.0000  IHL_frg=+1.0372  | CosSim(ul,re)=0.6719
[E01] loss=+6.777  UKR=+0.389  MKR=+2.013  CLS_ret=+1.286  DSL_ret=+0.5236  DSL_frg=+0.0000  IHL_frg=+1.0176  | CosSim(ul,re)=0.6219
[E02] loss=+6.089  UKR=+0.365  MKR=+1.919  CLS_ret=+1.105  DSL_ret=+0.3820  DSL_frg=+0.0000  IHL_frg=+1.0213  | CosSim(ul,re)=0.6677
[E03] loss=+5.679  UKR=+0.402  MKR=+1.813  CLS_ret=+1.022  DSL_ret=+0.2867  DSL_frg=+0.0000  IHL_frg=+0.9905  | CosSim(ul,re)=0.6713
[E04] loss=+5.246  UKR=+0.318  MKR=+1.739  CLS_ret=+0.942  DSL_ret=+0.2341  DSL_frg=+0.0000  IHL_frg=+0.9538  | CosSim(ul,re)=0.6699
```
<!-- /AUTO -->
...
|---|---|---|
| MIA_persample ↓ | **0.483** | (LoKU per-sample SVM) |
| MIA_paper ↓ | **0.571** | +0.000 ❌ |
| Forget AUC ↓ | **0.767** | +0.032 ❌ |
| Forget F1 ↓ | **0.456** | +0.063 ❌ |
| Test AUC ↑ | **0.681** | +0.056 ✅ |
| Test F1 ↑ | **0.352** | +0.102 ✅ |
| 1−CosSim ↓ | **0.327** | -0.123 ✅ |
| Time (h) | **0.110** | -4.890 ✅ |
| GPU peak (GB) | **11.78** | — |
