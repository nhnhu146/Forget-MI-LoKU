...
def build_dataset(args, tokenizer, image_noise_params=None):
    ...
    for name, ids, labels, trans, txt_map in [
        ...
        datasets[name] = CXRImageTextDataset(args.id, tk, mk, sg, lb, f_ids, args.img_data_dir, f_labels, args.data_split_path, transform=trans, output_channel_encoding=args.output_channel_encoding)
